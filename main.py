...
print(
    "Grid Vazio Currently: ",
    stats["current_grid_vazio"],
    round(stats["current_grid_vazio"] * price_vazio, 2),
)
print(
    "Grid Fora de Vazio Currently: ",
    stats["current_grid_fora_de_vazio"],
    round(stats["current_grid_fora_de_vazio"] * price_fora_de_vazio, 2),
)
current_cost = round(stats["current_grid_vazio"] * price_vazio, 2) + round(
    stats["current_grid_fora_de_vazio"] * price_fora_de_vazio, 2
)
print("Current Cost = ", current_cost)
print()
print(
    "Estimated Grid Vazio: ",
    stats["total_grid_vazio"],
    round(stats["total_grid_vazio"] * price_vazio, 2),
)
print(
    "Estimated Grid Fora de Vazio: ",
    stats["total_grid_fora_de_vazio"],
    round(stats["total_grid_fora_de_vazio"] * price_fora_de_vazio, 2),
)
print(
    "Estimated Cost = ",
    round(stats["total_grid_vazio"] * price_vazio, 2)
...
estimated_cost = round(stats["total_grid_vazio"] * price_vazio, 2) + round(
    stats["total_grid_fora_de_vazio"] * price_fora_de_vazio, 2
)
print()
print(
    "Estimated Batt Vazio: ",
    stats["total_batt_vazio"],
    round(stats["total_batt_vazio"] * price_vazio, 2),
)
print(
    "Estimated Batt Fora de Vazio: ",
    stats["total_batt_fora_de_vazio"],
    round(stats["total_batt_fora_de_vazio"] * price_fora_de_vazio, 2),
)
print()
